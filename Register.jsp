    ...
    <div class="row">
        ...
        <div class="col col-lg-3 d-flex justify-content-center align-items-center">
            <div class="row">
                ...
                <form id="myForm" onsubmit="return validateForm()" action="LoginServlet" method="post">
<%--                    <input type="e-mail" id="e-mail" name="txtName" placeholder="Enter your e-mail" class="login-input">--%>
                    <input type="text" id="username" name="txtName" placeholder="Enter your Name" class="login-input" required="required">
                    <input type="password" id="password" name="txtPwd" placeholder="Enter your password" class="login-input" required="required">
                    <div class="d-flex justify-content-center align-items-center">
                        <button type="submit" class="p-btn">Log In</button>
...
<%--                <p>New Admin?</p>--%>
<%--                <div class="d-flex justify-content-center align-items-center">--%>
<%--                    <a href="SignUp.jsp"><button type="button" class="p-btn">Signup</button></a>--%>
<%--                </div>--%>
            </div>
        </div>
    </div>
